...
class MaestrosViewEdit(generics.CreateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        maestro_serializer = MaestroSerializer(maestro, many=False).data
        maestro_serializer["materias_json"] = json.loads(maestro_serializer["materias_json"])
        return Response(maestro_serializer, 200)
